...
- [./drafts/20220518lc.md](./drafts/20220518lc.md)
  - [436. 寻找右区间（二分/双指针/lower_bound四个形参用法/go的sort.Slice重载比较函数）](./drafts/20220518lc.md#436-寻找右区间二分双指针lower_bound四个形参用法go的sortslice重载比较函数)
  - [699. 掉落的方块（有序集合，关于 C++ upper_bound 与红黑树 map 的 end 的理解， prev 函数）](./drafts/20220518lc.md#699-掉落的方块有序集合关于-c-upper_bound-与红黑树-map-的-end-的理解-prev-函数)
  - [730. 统计不同回文子序列（很好的动态规划）](./drafts/20220518lc.md#730-统计不同回文子序列很好的动态规划)
  - [324. 摆动排序 II（巧解）](./drafts/20220518lc.md#324-摆动排序-ii巧解)
  - [899. 有序队列（最小表示法模板题）](./drafts/20220518lc.md#899-有序队列最小表示法模板题)
  - [761. 特殊的二进制序列（构造/分治）](./drafts/20220518lc.md#761-特殊的二进制序列构造分治)
  - [768. 最多能完成排序的块 II（构造）](./drafts/20220518lc.md#768-最多能完成排序的块-ii构造)
- [./drafts/20220905lc.md](./drafts/20220905lc.md)
  - [652. 寻找重复的子树（递归哈希/编码/C++ tuple/重载 unordered_map哈希函数）](./drafts/20220905lc.md#652-寻找重复的子树递归哈希编码c-tuple重载-unordered_map哈希函数)
  - [850. 矩形面积 II（不错的扫描线模板+离散化）](./drafts/20220905lc.md#850-矩形面积-ii不错的扫描线模板离散化)
  - [银联-3. 风能发电（模拟）](./drafts/20220905lc.md#银联-3-风能发电模拟)
  - [银联-4. 设计自动售货机（双堆模拟懒删除+仿函数）](./drafts/20220905lc.md#银联-4-设计自动售货机双堆模拟懒删除仿函数)
  - [854. 相似度为 K 的字符串（思路打开，剪枝bfs）](./drafts/20220905lc.md#854-相似度为-k-的字符串思路打开剪枝bfs)
- [./drafts/20220921lc.md](./drafts/20220921lc.md)
  - [1206. 设计跳表（跳表 skip list ）](./drafts/20220921lc.md#1206-设计跳表跳表-skip-list)
