...
- [20241124周赛425](#20241124周赛425)
- [20241201周赛426](#20241201周赛426)
- [20241208周赛427](#20241208周赛427)
- [20241215周赛428](#20241215周赛428)
- [20241222周赛429](#20241222周赛429)
- [20241229周赛430](#20241229周赛430)
- [20250105周赛431](#20250105周赛431)
- [20250112周赛432](#20250112周赛432)
- [20250119周赛433](#20250119周赛433)
- [20250127周赛434](#20250127周赛434)
- [20250202周赛435](#20250202周赛435)
...
|425|584 / 2497|7|0:05:47🐛0|0:11:30🐛0|||00:11:30|
|426|498 / 2447|12|0:13:18🐛0|0:31:24🐛0|0:58:29🐛0||00:58:29|
|427|460 / 2376|12|0:06:47🐛0|0:38:06🐛0|1:08:46🐛1||01:13:46|
|428|841 / 2413|3|0:03:31🐛0||||0:03:31|
|429|1139 / 2308|3|0:05:08🐛0||||0:05:08|
...
- [6223. 移除子树后的二叉树高度（dfs）](./drafts/317.md#6223-移除子树后的二叉树高度dfs)
...
### 20241124周赛425
[./drafts/425.md](./drafts/425.md)

- [3364. 最小正和子数组（有序集合）](./drafts/425.md#3364-最小正和子数组有序集合)
- [3366. 最小数组和（多维DP）](./drafts/425.md#3366-最小数组和多维dp)

### 20241201周赛426
[./drafts/426.md](./drafts/426.md)

- [100444. 识别数组中的最大异常值（两数之和/简单推导）](./drafts/426.md#100444-识别数组中的最大异常值两数之和简单推导)
- [3373. 连接两棵树后最大目标节点数目 II（黑白染色/树dfs）](./drafts/426.md#3373-连接两棵树后最大目标节点数目-ii黑白染色树dfs)

### 20241208周赛427
[./drafts/427.md](./drafts/427.md)

- [3382. 用点构造面积最大的矩形 II（离线询问+离散化+树状数组）](./drafts/427.md#3382-用点构造面积最大的矩形-ii离线询问离散化树状数组)

### 20241215周赛428
[./drafts/428.md](./drafts/428.md)

- [3387. 两天自由外汇交易后的最大货币数（两次DFS）](./drafts/428.md#3387-两天自由外汇交易后的最大货币数两次dfs)
- [3388. 统计数组中的美丽分割（LCP数组/KMP）](./drafts/428.md#3388-统计数组中的美丽分割lcp数组kmp)
- [3389. 使字符频率相等的最少操作次数（枚举+DP+分类讨论）](./drafts/428.md#3389-使字符频率相等的最少操作次数枚举dp分类讨论)

### 20241222周赛429
[./drafts/429.md](./drafts/429.md)

- [3397. 执行操作后不同元素的最大数量（从小到大贪心）](./drafts/429.md#3397-执行操作后不同元素的最大数量从小到大贪心)
- [3399. 字符相同的最短子字符串 II（最大最小值二分）](./drafts/429.md#3399-字符相同的最短子字符串-ii最大最小值二分)

### 20241229周赛430
[./drafts/430.md](./drafts/430.md)

- [3404. 统计特殊子序列的数目（前后缀分解）](./drafts/430.md#3404-统计特殊子序列的数目前后缀分解)
- [3405. 统计恰好有 K 个相等相邻元素的数组数目（数学）](./drafts/430.md#3405-统计恰好有-k-个相等相邻元素的数组数目数学)

### 20250105周赛431
[./drafts/431.md](./drafts/431.md)

- [3413. 收集连续 K 个袋子可以获得的最多硬币数量（滑动窗口+贪心）](./drafts/431.md#3413-收集连续-k-个袋子可以获得的最多硬币数量滑动窗口贪心)
- [3414. 不重叠区间的最大得分（动态规划+二分）](./drafts/431.md#3414-不重叠区间的最大得分动态规划二分)

### 20250112周赛432
[./drafts/432.md](./drafts/432.md)

- [3419. 图的最大边权的最小值（二分+dfs）](./drafts/432.md#3419-图的最大边权的最小值二分dfs)
- [3420. 统计 K 次操作以内得到非递减子数组的数目（单调队列+单调栈+建图分析理解）](./drafts/432.md#3420-统计-k-次操作以内得到非递减子数组的数目单调队列单调栈建图分析理解)

### 20250119周赛433
[./drafts/433.md](./drafts/433.md)

- [3429. 粉刷房子 IV（记忆化搜索）](./drafts/433.md#3429-粉刷房子-iv记忆化搜索)
- [3430. 最多 K 个元素的子数组的最值之和（贡献法+单调栈）](./drafts/433.md#3430-最多-k-个元素的子数组的最值之和贡献法单调栈)

### 20250127周赛434
[./drafts/434.md](./drafts/434.md)

- [3432. 统计元素和差值为偶数的分区方案（脑筋急转弯）](./drafts/434.md#3432-统计元素和差值为偶数的分区方案脑筋急转弯)
- [3433. 统计用户被提及情况（模拟）](./drafts/434.md#3433-统计用户被提及情况模拟)
- [3434. 子数组操作后的最大频率（枚举+状态机DP）](./drafts/434.md#3434-子数组操作后的最大频率枚举状态机dp)

### 20250202周赛435
[./drafts/435.md](./drafts/435.md)
